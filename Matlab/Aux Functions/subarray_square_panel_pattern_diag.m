function [list_of_angles] = subarray_square_panel_pattern_diag(n, a)

    % TODO : make this general on square arrays with side n!

    % Given a square array of side (side), reorder and replicate the 
    % following 4 different angles to 
    % [a,a], [-a,a], [a,-a], [-a,-a]
