...
parent_folder = r"C:\Users\Srijan\Documents\SXRSIMv3\Matlab\TraceGeneration" + '\\'
...
for rot_factors in rot_factors_list:
    print('rotation factor', rot_factors)
    users = [None]
    ...
    for param in sim_params:
        ...
        output_str = f'{seed_str}_SPEED-{sp.speed_idx}_FREQ-{freq_idx}_' + \
                     ...
                     f'ROTFACTOR-{rot_factor}_cophase_0-1i'
