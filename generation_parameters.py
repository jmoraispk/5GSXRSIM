...
class Generation_parameters:
    ...
    def set_general_param_generation(self, seed):
        ...
        # TODO: does not work with soft batching...
        self.dry_run = False
        ...
        # Further note that if this option is off, all instances are computed
        self.specify_instances_to_compute = True
        # TODO fix this, not working for false *should read the parallel instances but not the first and last
        # REMEMBER TO CHECK THE VALUE OF THE VARIABLE BELOW!
        # TODO: this doesn't work well when it's set to False... FIX!
        ...
        # TODO: merge read_inputs_from_command_line and specify_instances_to_compute
        #       in some way... or place them as the main variables to check!
    ...
    def set_io_param(self, seed, speed):
        ...
        # TODO: MAKE THIS GENERATION-SPECIFIC!
    ...
    def check_vars_generation(self):
        ...
        if self.read_inputs_from_command_line and \
           self.specify_instances_to_compute:
            usage_print = \
                "Usage: sxrsim.py #instances_running_parallel" \
                "first_instance last_instance\n" \
                "E.g. 'sxrsim.py 30 1 120' will create 4 " \
                "batches of 30 instances running simultaneously\n" \
                "To stop command line input, the variable" \
    ...
    def set_and_save_matlab_parameters(self, speed):
        ...
        # Estimate the load of the simulation in Matlab
